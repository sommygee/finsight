  ...
  theme: {
    extend: {
      colors: {
        ...
        'brand-primary': 'var(--color-brand-primary)', // blue-800
        'brand-secondary': 'var(--color-brand-secondary)', // blue-500
        'brand-accent': 'var(--color-brand-accent)', // emerald-500
        'conversion-accent': 'var(--color-conversion-accent)', // orange-600
        'trust-builder': 'var(--color-trust-builder)' // blue-700
      },
      fontFamily: {
      ...
      boxShadow: {
        ...
        'elevation': '0 4px 6px -1px rgba(0, 0, 0, 0.1), 0 1px 3px 0 rgba(0, 0, 0, 0.1)',
      },
      animation: {
