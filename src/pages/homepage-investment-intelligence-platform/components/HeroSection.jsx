        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="text-white">
            ...
            <p className="text-xl text-blue-100 mb-8 leading-relaxed">
              Democratizing professional-grade investment tools and insights. Transform complex market data into clear, actionable intelligence with AI-powered analytics and intuitive user experiences.
            </p>
