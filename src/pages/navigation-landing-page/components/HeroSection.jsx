...
const HeroSection = () => {
  ...
  return (
    <section className="relative min-h-screen bg-gradient-to-br from-brand-primary via-blue-900 to-brand-secondary overflow-hidden">
      {/* Animated Background */}
      <div className="absolute inset-0">
        <div className="absolute inset-0 bg-gradient-to-r from-brand-primary/20 to-transparent animate-pulse"></div>
        <div className="absolute top-1/4 left-1/4 w-64 h-64 bg-brand-accent/10 rounded-full blur-3xl animate-bounce" style={{ animationDuration: '3s' }}></div>
        <div className="absolute bottom-1/3 right-1/4 w-96 h-96 bg-emerald-500/10 rounded-full blur-3xl animate-bounce" style={{ animationDelay: '1s', animationDuration: '4s' }}></div>
      </div>
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="text-white">
            ...
            <p className="text-xl text-blue-100 mb-8 leading-relaxed">
              Democratizing professional-grade investment tools and insights. Transform complex market data into clear, actionable intelligence with AI-powered analytics and intuitive user experiences that empower every investor to make smarter financial decisions.
            </p>
            ...
            <div className="flex flex-col sm:flex-row gap-4 mb-12">
              <Button 
                ...
                variant="default" 
                size="lg" 
                className="bg-white text-brand-primary hover:bg-gray-100 shadow-lg font-semibold"
                iconName="ArrowRight" 
                iconPosition="right"
              >
                Get Started
